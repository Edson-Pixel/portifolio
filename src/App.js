  ...
  return (
    <div className="background">
        ...
        <Navbar expand="md" className='background-menu' light>
          <img src="https://media-exp1.licdn.com/dms/image/C4D03AQHhcQs_Xhty6A/profile-displayphoto-shrink_100_100/0/1606271354952?e=1619654400&v=beta&t=JK2ihCyENDTzzDim0i6v1uHLbWCLUFvjKiopyv5LS2Q" alt={'perfil-Edson'} className="perfil" />
